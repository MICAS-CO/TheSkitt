...
export function RotaClosingNote({ caseId, score }: Props) {
  ...
  // governance accuracy:
  //   - M&Ms are clinician-led (consultant / senior registrar), not
  //     nursing-led; the M88 round-1 reviewer flagged the original
  //     attribution to Akin.
  //   - M&Ms are MONTHLY retrospective chart reviews, not real-time
  //     write-ups (M91 user feedback). McGrath will pull the chart
  //     and do the review later — not tonight, not this weekend.
  //   - Safeguarding misses go via safeguarding reviews / Datix,
  //     which is a separate governance pathway.
  let body: string;
  switch (tone) {
    case 'cleared':
      body =
        ...
        "I'll be pulling Mr Okafor's chart for next month's M&M. You're in it. Then go home.";
      break;
    case 'borderline':
      body =
        ...
        "I'll be doing his chart review for next month's M&M. Bring questions to the next governance round.";
      break;
    case 'failed':
      body =
        ...
        "But the Just Culture work is the bigger task. I'll be pulling Mr Okafor's chart for next month's M&M; you'll have copies of the safeguarding review on Chloe and Stan too. Come to the next governance round with what you'd say.";
      break;
  }
